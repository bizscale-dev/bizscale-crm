...
export default async function WritersManagerEodPage() {
  ...
  // active writer client across every writer campaign (writer_clients — populated
  // automatically from the GBP-Off/Web-Off sheets, see writerOffpageSync.js), not
  // scoped to whichever writer campaign happens to be active right now.
