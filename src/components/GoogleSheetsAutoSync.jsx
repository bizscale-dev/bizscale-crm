    ...
    <div>
      ...
      <div style={cardStyle}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginBottom: '1rem' }}>
          Manually sync clients from your Google Sheet. This runs automatically at 2 PM and 11:50 PM (Pakistan Time) daily.
        </p>
      ...
      <div style={{ ...cardStyle, backgroundColor: 'rgba(99, 102, 241, 0.05)', border: '1px solid var(--primary)' }}>
        <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: '0.875rem' }}>
          ℹ️ <strong>Auto-sync runs daily at 2 PM and 11:50 PM (Pakistan Time).</strong> New clients added to your sheet are automatically assigned to associates and tasks are created from today to end of cycle. Deactivated clients lose only future tasks.
        </p>
      </div>
    </div>
  );
